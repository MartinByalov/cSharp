public class MarginAnalysis
{
    public static void Main(string[] args)
    {
        ...
        // Аритметична операция (Изчисление на марж)
        double grossMargin = (sales - costOfGoods) / sales; 
        
        // Логическа операция (Проверка на условие)
        ...
        // Teambuilding - Остатък при деление (Модулно деление)
        int clients = 7;
        int teams = 3;
